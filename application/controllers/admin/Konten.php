...
class Konten extends CI_Controller {
    ...
    public function simpan(){
        ...
        <?php
        if($cek<>NULL){
            $this->session->set_flashdata('Judul Konten Sudah Ada.');
            ?>
            <script>
                Swal.fire({
                    icon: "error",
                    title: "Waduh...",
                    text: "Judul Konten Sudah Ada."
                }).then((result) => {
                    window.location ='<?= site_url('admin/konten') ?>';
                });
            </script>
        ...
        $this->session->set_flashdata('alert','Berhasil Menambahkan konten.');
    ...
    public function update(){
        ...
        $this->session->set_flashdata('alert','Berhasil Memperbarui konten.');
        redirect('admin/konten');
    }
    public function delete_data($id){
        ...
        $this->session->set_flashdata('alert','Berhasil Menghapus Konten.');
        redirect('admin/konten');
    }
}
